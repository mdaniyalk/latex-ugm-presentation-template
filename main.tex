...
\title[short title]{Long Title of the Presentation} % The short title appears at the bottom of every slide, the full title is only on the title page
\subtitle{Subtitle}

\author[Surname]{Name Surname}
\institute[Universitas Gadjah Mada]{Department of Electrical and Information Engineering \newline Faculty of Engineering\newline Universitas Gadjah Mada}
